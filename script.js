...
function handleLogin(e) {
    ...
    // Check if user exists - FIXED: Only registered users can login
...
function showAdminSection(sectionName) {
    ...
    document.getElementById('admin-transactions-section').style.display = 'none';
    document.getElementById('admin-kyc-section').style.display = 'none';
    ...
    switch(sectionName) {
        case 'users':
            ...
            break;
        case 'transactions':
            document.getElementById('admin-transactions-section').style.display = 'block';
            loadAllTransactions();
            break;
        case 'kyc':
            document.getElementById('admin-kyc-section').style.display = 'block';
            loadKYCApprovals();
            break;
        case 'settings':
